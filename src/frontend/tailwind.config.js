  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        subtle: "0 2px 12px -2px rgba(16, 60, 32, 0.08)",
        elevated: "0 12px 40px -12px rgba(16, 60, 32, 0.16)",
        "elevated-lg": "0 24px 70px -24px rgba(16, 60, 32, 0.22)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "scan-progress": "scan-progress 1.4s ease-in-out infinite",
        "card-swipe": "card-swipe 0.7s cubic-bezier(0.22, 1, 0.36, 1) both",
